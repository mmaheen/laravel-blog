        ...
        <div class="container-fluid">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-5 order-1 order-lg-2 why-us-img">
                    <img src="{{ asset('assets/frontend') }}/img/why-us.png" class="img-fluid" alt=""
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="steps-item">
                        <div class="steps-image">
                            <img src="{{ asset('assets/frontend') }}/img/steps/steps-1.webp" alt="Step 1"
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="steps-item">
                        <div class="steps-image">
                            <img src="{{ asset('assets/frontend') }}/img/steps/steps-2.webp" alt="Step 2"
                                class="img-fluid" loading="lazy">
                        </div>
                        <div class="steps-content">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="steps-item">
                        <div class="steps-image">
                            <img src="{{ asset('assets/frontend') }}/img/steps/steps-3.webp" alt="Step 3"
                                class="img-fluid" loading="lazy">
                        </div>
                        <div class="steps-content">
