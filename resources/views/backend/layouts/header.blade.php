            ...
            <ul class="clearfix">
                        ...
                        <div class="dropdown-content-body">
                            <ul>
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="float-left mr-3 avatar-img"
                                            src="{{ asset('assets/backend/images/avatar/1.jpg') }}" alt="">
                                ...
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="float-left mr-3 avatar-img"
                                            src="{{ asset('assets/backend/images/avatar/2.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="float-left mr-3 avatar-img"
                                            src="{{ asset('assets/backend/images/avatar/3.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="float-left mr-3 avatar-img"
                                            src="{{ asset('assets/backend/images/avatar/4.jpg') }}" alt="">
                                        <div class="notification-content">
                ...
                <li class="icons dropdown">
                    <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                        ...
                        <img src="{{ Auth::user()->image ? asset('uploads/users/' . Auth::user()->image) : asset('assets/default_images/user.jpg') }}"
