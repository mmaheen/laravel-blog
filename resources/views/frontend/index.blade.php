                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="skills-content skills-animation">
                        ...
                        @foreach ($skills as $skill)
                            <div class="progress">
                                <span class="skill"><span>{{ $skill->title }}</span> <i
        ...
        <div class="container">
            ...
            <div class="row" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="col-xl-3 cta-btn-container text-center">
                    <a class="cta-btn align-middle" href="#portfolio">Let’s Get Started</a>
                </div>
            </div>
                ...
                @foreach ($teams as $team)
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('uploads/users/' . $team->user->image) }}"
                    ...
                    @foreach ($testimonials as $testimonial)
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('uploads/users/' . $testimonial->user->image) }}"
                                    class="testimonial-img" alt="">
                                <h3>{{ ucfirst($testimonial->user->name) }}</h3>
                                <h4>
                                    {{ ucfirst($testimonial->user->role) }}
                                    {{ ucfirst($testimonial->user->team ? '& ' . $testimonial->user->team->designation : '') }}
                                </h4>
                                <div class="stars">
